...
def StarAnnualAnalysis():
    ...
    for DataResults in RESULTS:
        ...
        addTimePowerDataResultsToPlot(DataResults[0], DataResults[4], PowerPlot, ColorPower, NamePower, 0)
        addTimePowerDataResultsToPlot(DataResults[0], DataResults[4], PowerPlot, ColorPower, NamePower, 1)
